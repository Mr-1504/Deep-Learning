...
def get_args():
    ...
    parser.add_argument('-b', '--batch_size', type=int, default=128) # số ảnh 1 ;lần train
    parser.add_argument('-e', '--epochs', type=int, default=2)
    parser.add_argument('-l', '--lr', type=float, default=1e-2)  # SGD: lr = 1e-2. Adam: lr = 1e-3
    parser.add_argument('-s', '--image_size', type=int, default=400)
...
def plot_phase(train_accuracies_epochs, train_loss_value_epochs, val_accuracies_epochs, val_loss_value_epochs):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('AlexNet_training_result.png')
