...
def get_args():
    ...
    parser.add_argument('-p', '--data_path', type=str, default="../resoucre")
    ...
    parser.add_argument('-t', '--tensorboard_path', type=str, default="D:\\Code\\\Vigilant-VGG16\\tensorboard")
    parser.add_argument('-r', '--trained_path', type=str, default="D:\\Code\\\Vigilant-VGG16\\trained_models")
...
def train(args):
    ...
    for ax, img in zip(axes, sample_images):
        arr_img = img.numpy().transpose(1, 2, 0)
