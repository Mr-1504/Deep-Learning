...
from Yaw.src.Dataset import Yaw
from torchvision.transforms import Compose, ToTensor, Resize, RandomRotation, RandomHorizontalFlip, ColorJitter, \
    GaussianBlur
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for iter, (images, labels) in enumerate(progress_bar):
            ...
            _, predicted = torch.max(predictions.data,
                                     1)  # " _, " nghĩa là bỏ qua giá trị đầu tiên trả về, chỉ sd gt thứ 2
